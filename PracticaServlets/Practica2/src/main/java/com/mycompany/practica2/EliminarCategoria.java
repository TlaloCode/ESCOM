...
public class EliminarCategoria extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            out.println("<h1>REGISTRO DE CATEGORIAS</h1>");
            out.println("<h4>Registro eliminado</h4>");
            out.println("<a href='Listado'>Regresar al listado</a>");
            out.println("</div>");
            
            out.println("<h1>Servlet EliminarCarrera at "+request.getContextPath()+"</h1>");
            out.println("</body>");
            out.println("</html>");
            }
    }
